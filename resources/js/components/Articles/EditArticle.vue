    ...
    <form @submit.prevent="modifierproduit">
        ...
        <div class="form-group">
            <input
                ...
                v-model="article.caracteristiques"
            />
        </div>
        <div class="form-group">
            <input
                type="number"
                class="form-control"
                placeholder="prixAchat"
                v-model="article.prixAchat"
            />
        </div>
        <div class="form-group">
            <input
        ...
        <div class="form-group">
            <input
                type="number"
                class="form-control"
                placeholder="prixSolde"
                v-model="article.prixSolde"
            />
        </div>
        <div class="form-group">
            <input
        ...
        <div class="form-group">
            <FilePond
                @change="onFileChangeM"
                :files="tab"
                @removefile="onRemoveFileClick"
            />
        </div>
...
export default {
    ...
    methods: {
        ...
        getscategories(event) {
            ...
            this.axios
                .get("http://localhost:8000/api/scat/" + categ)
                .then((res) => {
